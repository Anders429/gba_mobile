...
where
    ...
    Config: config::Mode,
{
    internal: driver::error::dns::Error<Socket1, Socket2, Dns, Config>,
}
...
impl<Socket1, Socket2, Dns, Config> From<driver::error::dns::Error<Socket1, Socket2, Dns, Config>>
...
where
    ...
    Config: config::Mode,
{
    fn from(error: driver::error::dns::Error<Socket1, Socket2, Dns, Config>) -> Self {
        Self { internal: error }
    }
}
