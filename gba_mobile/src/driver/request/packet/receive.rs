use crate::driver::{Adapter, Command, adapter, command, sink};
use core::{
...
#[derive(Debug)]
pub(in crate::driver) enum Step8 {
    MagicByte1 {
        sink: sink::Command,
        frame: u16,
    },
...
#[derive(Debug)]
pub(in crate::driver) enum Step32 {
    MagicByte {
        sink: sink::Command,
        frame: u16,
    },
...
#[derive(Debug)]
pub(in crate::driver) enum Step8Error {
    MagicByte2 {
        sink: sink::Command,
    },
...
#[derive(Debug)]
pub(in crate::driver) enum Step32Error {
    HeaderLength {
        sink: sink::Command,
    },
    Data {
